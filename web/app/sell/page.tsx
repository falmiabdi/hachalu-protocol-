...
function SellWizard() {
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-8 sm:px-6">
      <h1 className="text-2xl font-extrabold text-secondary">Sell on Hachalu</h1>
      <p className="mb-6 text-sm text-muted-foreground">
        List a product for the shop — add photos, details and pricing. Products are reviewed before going live.
      </p>
      ...
      <div className="flex items-center justify-end gap-3">
        <Button variant="ghost" onClick={() => router.push("/agent")}>Cancel</Button>
